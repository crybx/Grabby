...
//
// Auto-grab runs unbounded; the loop exits when an abort signal fires
// (locked/error/page-change check) or when the duplicate detector closes the tab.
//
// Example usage:
// "example.com": {
//     grabber: grabExample,
...
//     autoNav: { enabled: true, defaultDelay: 5, activeTab: true }  // Auto-nav config
// }
const WEBSITE_CONFIGS = {
    ...
    singleDomains: {
        ...
        "brightnovels.com": {
            ...
            autoNav: { enabled: true, defaultDelay: 5 }
        },
        ...
        "peachtea.agency": {
            ...
            autoNav: { enabled: true, defaultDelay: 60, activeTab: true }
        },
        "readhive.org": {
        ...
        "starlightstream.net": {
            ...
            postGrab: { fn: "GrabActions.clickElementWithText", args: ["Next", { exact: true }] },
            autoNav: { enabled: true, defaultDelay: 20 }
        },
        "storyseedling.com": {
